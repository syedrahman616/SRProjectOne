...
function Login(){
                ...
                <div className="loginpagecenter">
                       <div className="row p-5">
                        <div className="col-6">
                         ...
                         <label>Don't have an account? <Link to='/signuppage'><b style={{color:'#6caddf',textDecoration:'underline'}}>Sign Up</b></Link></label>
                         </div>
                        </div>
    ...
    <input type="text" className="form-control logininput" placeholder="Enter your name" />
  </div>
    ...
    <i className='fa fa-lock ml-2'></i>
              ...
              <div className="mt-4">
              <button className="loginbutton" onClick={log}>Login</button>
              </div>
                        </div>
                       </div>
                </div>
